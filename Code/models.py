...
class AlexNet(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=11, **kwargs):
        super().__init__()
...
class GreenNet(nn.Module):
    """Lightweight model for Green Initiative"""
    def __init__(self, in_channels, num_classes, activation_str = "ReLU", drop_rate=0.3):
        super().__init__()
